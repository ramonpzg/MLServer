---
title: "XGBoost runtime for MLServer"
---
...
`ModelSettings <mlserver.settings.ModelSettings>` config (see the
...
`outputs` field of your `InferenceRequest <mlserver.types.InferenceRequest>` payload.
